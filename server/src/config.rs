...
impl Config {
    pub fn from_env() -> Result<Self> {
        Ok(Self {
            ...
            frontend_url: var("FRONTEND_URL").unwrap_or_else(|_| "http://localhost:5173".into()),
            redis_url: var("REDIS_URL").unwrap_or_else(|_| "redis://127.0.0.1/".into()),
            app_url: var("APP_URL").unwrap_or_else(|_| "http://localhost:5173".into()),
